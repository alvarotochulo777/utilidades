...
//    limite
//
//      Valor máximo (no incluido) porque no llega al limite.
//
//  VALOR DE SALIDA:
//
...
//  USO:
//
//    Pide una letra y comprueba que es valida, que es del codigo ASCII.
//
//  DETALLES:
//
//    Es como un getchar() mejorado.
//
//  PARÁMETROS DE ENTRADA:
//
//    Ninguno.
...
//  USO:
//
//    Es como pedir entero pero comprueba que es poditivo y sino pone que es erroneo.
//
//  DETALLES:
//
//    Se hace a traves de un bucle do, while.
//
//  PARÁMETROS DE ENTRADA:
//
//    char msjtxt[], int ncols, boolean mostrarerror.
//
//  VALOR DE SALIDA:
//
//    num, el numero que es valido
//
//  FUNCIONES DE LAS QUE DEPENDE:
//
//    obtenerEntero()
...
//  USO:
//
//    Es como la anterior pero aparte del intervalo dado al ser positivo tu pones tu 
//	  propio intervalo.
//
//  DETALLES:
//
//    Esos valores se dan con un valor minimo y un valor maximo.
//
//  PARÁMETROS DE ENTRADA:
//
//    char msjtxt[], int ncols, boolean mostrarerror, int min, int max
//
//  VALOR DE SALIDA:
//
//    num, que es el numero que esta dentro del intervalo pedido
//
//  FUNCIONES DE LAS QUE DEPENDE:
//
//    obtenerEntero(),nuevaLinea(),mensaje_x_y,printf,mensaje
//
////////////////////////////////////////////////////////////////////////////////
...
//  USO:
//
//    Pide una letra en un lugar determinado y sino es la correcta da un mensaje de error.
//
//  DETALLES:
//
//    Da igual si usas mayusculas o minusculas, porque  siempre la pasa a mayuscula.
//
//  PARÁMETROS DE ENTRADA:
//
//    char msjtxt[], int ncols, boolean mostrarerror, char letra
//
//  VALOR DE SALIDA:
//
//    pedidda que es como hemos llamado a a letra pedida.
//
//  FUNCIONES DE LAS QUE DEPENDE:
//
//    mensaje();mostrar();obtenerLetra(),nuevaLinea();toupper()
//
////////////////////////////////////////////////////////////////////////////////
...
//  USO:
//
//    Es muy parecido al anterior pero en este caso salta un mensaje dentro del programna con Si o No deendiendo de si es correcto lo que han dado
//
//  DETALLES:
//
//    Da igual si usas mayusculas o minusculas, porque  siempre la pasa a mayuscula.
...
//  VALOR DE SALIDA:
//
//    letra, que es como hemos llamado a la letra pedida
//
//  FUNCIONES DE LAS QUE DEPENDE:
//
//    obtenerLetra(),mensajenuevaLinea();mensaje_x_y,toupper()
//
////////////////////////////////////////////////////////////////////////////////
...
//  USO:
//
//    Comprueba que la letra dada y la que va a enviar sean la misma
//
//  DETALLES:
//
...
//  PARÁMETROS DE ENTRADA:
//
//    char original, char dada, boolean sensibleamayusculas
//
//  VALOR DE SALIDA:
//
//    Devuelvo lo que salga de esta comprobacion: original == dada
//
//  FUNCIONES DE LAS QUE DEPENDE:
//
//    la funcion toupper()
...
//  USO:
//
//    Pide una letra entre un conjunto que le des de un texto.
//
//  DETALLES:
//
//    Otra vez mas lo de que la sensibilidad a las mayusculas
//
//  PARÁMETROS DE ENTRADA:
//
//    char letra, char seleccion[], boolean sensibleamayusculas
//
//  VALOR DE SALIDA:
//
//    Resultado, sea verdadero o falso.
//
//  FUNCIONES DE LAS QUE DEPENDE:
//
//    validarLetraUnica()
...
//  USO:
//
//    Sirve basicamente para generar una cadena con las opciones separadas por '/'
//
//  DETALLES:
//
//    nos da un ejemplo: "ABC" -> "A/B/C"
//
//  PARÁMETROS DE ENTRADA:
//
//    char entrada[]
...
//  VALOR DE SALIDA:
//
//    textofinal eso que devolvemos es una cadena al igual que lo que entra pero con la mejora correspondiente.
//
//  FUNCIONES DE LAS QUE DEPENDE:
//
//    O ninguna o alguna interna que no conozco
//
////////////////////////////////////////////////////////////////////////////////
...
//  DETALLES:
//
//    Ninguno en especial, simplemente que vuelve a mirar lo de las mayusculas
//
//  PARÁMETROS DE ENTRADA:
//
//    char msjtxt[], int ncols, boolean mostrarerror, char seleccion[], boolean sensibleamayusculas
//
//  VALOR DE SALIDA:
//
//    letra que es la que nos da de ese conjunto
//
//  FUNCIONES DE LAS QUE DEPENDE:
//
//    mensaje();mostrar();printf();obtenerLetra();nuevaLinea()toupper()
//
////////////////////////////////////////////////////////////////////////////////
...
//  USO:
//
//    Sirve para ver que tecla del teclado has pulsado, concretamente de las flechas y del intro y espacio.
//
//  DETALLES:
//
//    Abajo hay una igual pero para windows
//
//  PARÁMETROS DE ENTRADA:
//
//    Ninguno.
...
//  VALOR DE SALIDA:
//
//    caracter, que es basicamente la tecla pulsada
//
//  FUNCIONES DE LAS QUE DEPENDE:
//
//    Funciones de librerias internas.
//
////////////////////////////////////////////////////////////////////////////////
